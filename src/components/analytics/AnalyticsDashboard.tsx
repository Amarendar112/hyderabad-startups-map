...
export default function AnalyticsDashboard({ startups }: AnalyticsDashboardProps) {
  ...
  return (
    <div className="w-full space-y-4 sm:space-y-6">
      {/* Analytics Banner */}
      <div className="bg-gradient-to-r from-indigo-950/70 via-slate-900 to-purple-950/70 p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-slate-800 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-white">Ecosystem Intelligence & Analytics</h2>
        ...
        <div className="grid grid-cols-2 gap-2.5 sm:gap-3 w-full md:w-auto">
          <div className="px-3.5 sm:px-4 py-2.5 sm:py-3 rounded-2xl bg-slate-950/90 border border-slate-800 text-center">
            <span className="text-xl sm:text-2xl font-extrabold text-amber-400">{unicornCount}</span>
            <span className="text-[10px] sm:text-[11px] text-slate-400 block font-semibold">Tech Unicorns</span>
          </div>

          <div className="px-3.5 sm:px-4 py-2.5 sm:py-3 rounded-2xl bg-slate-950/90 border border-slate-800 text-center">
            <span className="text-xl sm:text-2xl font-extrabold text-emerald-400">{hiringCount}</span>
            <span className="text-[10px] sm:text-[11px] text-slate-400 block font-semibold">Hiring Ventures</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-slate-900 border border-slate-800 p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-xl space-y-4">
